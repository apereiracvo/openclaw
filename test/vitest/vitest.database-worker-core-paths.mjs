...
export const databaseWorkerCoreTestFiles = [
  ...
  "src/acp/control-plane/manager.one-shot-resume.integration.test.ts",
  ...
  "src/meeting-bot/transcripts-bridge.provenance.test.ts",
  ...
  "src/cli/program/config-guard.legacy-state.test.ts",
  ...
  "src/tasks/task-registry.maintenance-cron.test.ts",
  ...
  "src/plugin-sdk/agent-harness-task-runtime.worker.test.ts",
