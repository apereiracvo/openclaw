...
<AccordionGroup>
  <Accordion title="Send and history semantics">
    ...
    - Session activity uses a ring as soon as work is accepted. It spins during startup and execution, pauses while waiting for a scheduler concurrency slot, and resumes when a slot is granted. With reduced motion enabled, rings remain still.
